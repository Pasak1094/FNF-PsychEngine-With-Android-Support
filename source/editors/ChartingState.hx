...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Shake Arrows', "Makes arrows move wavy on Laughin'.\nValue 1: Intensity\nValue 2: Duration in seconds."],
		['Toggle Enemy Arrows Making Damage', "Makes opponent arrow presses hurt you. >:)"],
		['Lightning Strike', "Used on Glasses. Speaks for itself."],
		['PZDC Statue Fall', "Speaks for itself."],
		['Explode Bottly', "Speaks for itself."]
	];
